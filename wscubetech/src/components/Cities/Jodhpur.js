...
const JaipurSchool = {
    title: "WsCube Career School - Jodhpur",
    descriptions: [
...
const JodhpurLerners = {
    name: "Pushpendra Singh Rathore",
    description: "Learning Digital Marketing from WsCube Tech was an outstanding experience. The team is diligent in every aspect, from class schedules, to fee arrangements, and providing ample support in regards to education. The trainers are extremely supportive, making the whole experience truly enjoyable.",
...
const Jodhpur = () => {
    return (
        <div>
            <CareerSchool data={JaipurSchool} />
            <JobCourse data={Jodhpurcourses} />
            <Lerner lernerData={JodhpurLerners} />
